...
class env:
    ...
    def op_and(self,obj,tab):
        carv = obj.car().eval(tab)
        cdrv = obj.cdr()
        if carv == nil :
            return nil   #break
        elif cdrv == nil :
            ...
            return self.op_and(cdrv, tab)
    
    def op_or(self,obj,tab):
        carv = obj.car().eval(tab)
        cdrv = obj.cdr()
        if carv != nil :
            return carv
            ...
            return nil
        else: #car=nil cdrv!=nil
            return self.op_or(cdrv, tab)
    ...
    def builtins(self):
        ...
        self.add(gtab, 'and', sym('and', lambda x, tab: self.op_and(x, tab), gtab))
        self.add(gtab, 'or', sym('or', lambda x, tab: self.op_or(x, tab), gtab))
